...
const Events = () => {
  return (
    <section className="events ptb48">
      <div className="events-container wrapper2 df fww aic ptb40">
        <div className="events-contents flx50 pr32">
          <h2 className="events-heading fs42 fw7 lh48 mb24 fc6 ff2">
            I WALK - I CARE
          </h2>
        ...
        <div className="events-form flx50 p24 bs3 br4">
